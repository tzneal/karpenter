...
import (
	...
	typedkarpenterv1alpha5 "github.com/aws/karpenter/pkg/client/clientset/versioned/typed/provisioning/v1alpha5"
	...
	if untyped == nil {
		if injection.GetConfig(ctx) == nil {
			logging.FromContext(ctx).Panic(
				"Unable to fetch github.com/aws/karpenter/pkg/client/clientset/versioned.Interface from context. This context is not the application context (which is typically given to constructors via sharedmain).")
		} else {
			logging.FromContext(ctx).Panic(
				"Unable to fetch github.com/aws/karpenter/pkg/client/clientset/versioned.Interface from context.")
		}
	}
...
// KarpenterV1alpha5 retrieves the KarpenterV1alpha5Client
func (w *wrapClient) KarpenterV1alpha5() typedkarpenterv1alpha5.KarpenterV1alpha5Interface {
	return &wrapKarpenterV1alpha5{
		dyn: w.dyn,
	}
}

type wrapKarpenterV1alpha5 struct {
	dyn dynamic.Interface
}

func (w *wrapKarpenterV1alpha5) RESTClient() rest.Interface {
...
func (w *wrapKarpenterV1alpha5ProvisionerImpl) Create(ctx context.Context, in *v1alpha5.Provisioner, opts v1.CreateOptions) (*v1alpha5.Provisioner, error) {
...
func (w *wrapKarpenterV1alpha5ProvisionerImpl) Update(ctx context.Context, in *v1alpha5.Provisioner, opts v1.UpdateOptions) (*v1alpha5.Provisioner, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "karpenter.sh",
		Version: "v1alpha5",
		Kind:    "Provisioner",
...
func (w *wrapKarpenterV1alpha5ProvisionerImpl) UpdateStatus(ctx context.Context, in *v1alpha5.Provisioner, opts v1.UpdateOptions) (*v1alpha5.Provisioner, error) {
	in.SetGroupVersionKind(schema.GroupVersionKind{
		Group:   "karpenter.sh",
		Version: "v1alpha5",
		Kind:    "Provisioner",
...
func (w *wrapKarpenterV1alpha5ProvisionerImpl) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
