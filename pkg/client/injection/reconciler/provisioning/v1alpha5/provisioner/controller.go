...
import (
	...
	versionedscheme "github.com/aws/karpenter/pkg/client/clientset/versioned/scheme"
	client "github.com/aws/karpenter/pkg/client/injection/client"
	provisioner "github.com/aws/karpenter/pkg/client/injection/informers/provisioning/v1alpha5/provisioner"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "provisioner-controller"
	defaultFinalizerName       = "provisioners.karpenter.sh"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	provisionerInformer := provisioner.Get(ctx)

	lister := provisionerInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "karpenter.sh.Provisioner"),
	)
