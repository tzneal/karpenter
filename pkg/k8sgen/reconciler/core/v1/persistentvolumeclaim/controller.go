...
const (
	defaultControllerAgentName = "persistentvolumeclaim-controller"
	defaultFinalizerName       = "persistentvolumeclaims.core"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	lister := persistentvolumeclaimInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "core.PersistentVolumeClaim"),
	)
